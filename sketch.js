...
function setup(){
    canvas = createCanvas(885,600);

    block1 = createSprite(105,580,210,30);
    block1.shapeColor = "blue";

    block2 = createSprite(330,580,210,30);
    block2.shapeColor = "orange";

    //create two more blocks i.e. block3 and block4 here

    block3 = createSprite(555,580,210,30);
    block3.shapeColor = "red";

    block4 = createSprite(780,580,210,30);
    block4.shapeColor = "green";

    ball = createSprite(random(20,825),100, 40,40);
